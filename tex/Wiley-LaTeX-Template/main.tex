...
\section{Annotation Demo Section}

This section shows how annotation can be used for MRM revisions.  LaTeX function definitions and required support libraries are provided at the top of the source file for this document.  To enable/disable display of the annotations, simply uncomment the set of functions following the directions above their definitions.  To highlight text that has been added in the revision, the {\tt \textbackslash add\{$\cdot$\}} function can be used. For example, including {\tt \textbackslash add\{This text has been added in the revision\}} in your source will produce \add{This text has been added in the revision}. Similarly, to highlight text that has been deleted in the revision, the {\tt \textbackslash delete\{$\cdot$\}} function can be used. For example, including {\tt \textbackslash delete\{This text has been deleted in the revision\}} in your source will produce \delete{This text has been deleted in the revision}.  In cases where text is replaced in a revision, a convenience edit function is also included that combines the addition and deletion feature. For example, including {\tt \textbackslash edit\{This text has been deleted in the revision\}\{This text has been added\}} in your source will produce \edit{This text has been deleted in the revision}{This text has been added in the revision}.Finally, marginal notes indicating for which reviewer comment a modification is associated with can be include using the {\tt \textbackslash mnote\{$\cdot$\}} function. For example, adding the following in the source file {\tt \textbackslash mnote\{R2.3\} \textbackslash add\{Information requested by Reviewer 2 in comment 3\}} will produce \mnote{R2.3}\add{Information requested by Reviewer 2 in comment 3}.
